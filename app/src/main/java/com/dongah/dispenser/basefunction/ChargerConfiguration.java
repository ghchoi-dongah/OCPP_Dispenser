...
//    public int serverPort = 5000;
    ...
    public String serverConnectingString = "octt.dongahtest.p-e.kr";
    ...
    public String securityProfile = "1";
    ...
    public void onLoadConfiguration() {
        try {
            ...
            if (!TextUtils.isEmpty(configurationString)) {
                ...
                setStopConfirm(obj.optBoolean("STOP_CONFIRM", false));
                setChargerPowerType(obj.optBoolean("CHARGER_POWER_TYPE", false));
                setConfigCnt(obj.optInt("CONFIG_CNT", 10));
                setSigned(obj.getBoolean("SIGNED"));
                setTargetSoc(obj.getInt("TARGET_SOC"));
                setSecurityProfile(obj.optString("SECURITY_PROFILE", "1"));
                GlobalVariables.setSecurityProfile(getSecurityProfile());
            }
        } catch (Exception e) {
    ...
    public void onSaveConfiguration() {
        try {
            ...
            obj.put("CHARGER_POWER_TYPE", isChargerPowerType());
            obj.put("CONFIG_CNT", getConfigCnt());
            obj.put("SIGNED", isSigned());
            obj.put("TARGET_SOC", getTargetSoc());
            obj.put("SECURITY_PROFILE", getSecurityProfile());
