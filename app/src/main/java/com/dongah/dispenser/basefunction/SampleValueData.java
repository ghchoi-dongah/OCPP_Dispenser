...
public class SampleValueData {
    ...
    public SampleValueData() {
        ...
        sampledValues[0].setContext("Sample.Periodic");
        ...
        sampledValues[1].setContext("Sample.Periodic");
        ...
        sampledValues[2].setContext("Sample.Periodic");
        ...
        sampledValues[4].setContext("Sample.Periodic");
        ...
        sampledValues[5].setContext("Sample.Periodic");
        ...
        sampledValues[6].setContext("Sample.Periodic");
