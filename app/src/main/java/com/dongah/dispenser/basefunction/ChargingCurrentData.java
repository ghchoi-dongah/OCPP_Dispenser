...
public class ChargingCurrentData {
    ...
    boolean pendingStopTxConf = false;
    boolean finishingNotifSent = false;

    public SampleValueData sampleValueData;
    public SampleAlignedValueData sampleAlignedValueData;
    ...
    public boolean remoteStart = false;
    ...
    public ChargingCurrentData(int channel) {
        this.channel = channel;
        sampleValueData = new SampleValueData();
        sampleAlignedValueData = new SampleAlignedValueData();
    }

    public void onCurrentDataClear() {
        sampleValueData.initSampledValues();
        sampleAlignedValueData.initSampledValues();
        setIdTag("");
        setPayId("");
        setUserStop(false);
        ...
        setPendingStopTxConf(false);
        setFinishingNotifSent(false);
        setRemaintime(0);
        setRemainTimeStr("");
        setParentIdTag("");
        setIdTagStop("");
    ...
    public boolean isPendingStopTxConf() {
        return pendingStopTxConf;
    }

    public void setPendingStopTxConf(boolean pendingStopTxConf) {
        this.pendingStopTxConf = pendingStopTxConf;
    }

    public boolean isFinishingNotifSent() {
        return finishingNotifSent;
    }

    public void setFinishingNotifSent(boolean finishingNotifSent) {
        this.finishingNotifSent = finishingNotifSent;
    }
    ...
    public SampleAlignedValueData getSampleAlignedValueData() {
        return sampleAlignedValueData;
    }

    public void setSampleAlignedValueData(SampleAlignedValueData sampleAlignedValueData) {
        this.sampleAlignedValueData = sampleAlignedValueData;
    }

    public String[] getMaxProfileSchedulePeriod() {
        return maxProfileSchedulePeriod;
    }

    public void setMaxProfileSchedulePeriod(String[] maxProfileSchedulePeriod) {
        this.maxProfileSchedulePeriod = maxProfileSchedulePeriod;
    }

    public String[] getDefaultProfileSchedulePeriod() {
        return defaultProfileSchedulePeriod;
    }

    public void setDefaultProfileSchedulePeriod(String[] defaultProfileSchedulePeriod) {
        this.defaultProfileSchedulePeriod = defaultProfileSchedulePeriod;
    }

    public String[] getTxProfileSchedulePeriod() {
        return txProfileSchedulePeriod;
    }

    public void setTxProfileSchedulePeriod(String[] txProfileSchedulePeriod) {
        this.txProfileSchedulePeriod = txProfileSchedulePeriod;
    }

    public JSONArray getRemoteSmartChargingJsonArray() {
        return remoteSmartChargingJsonArray;
    }

    public void setRemoteSmartChargingJsonArray(JSONArray remoteSmartChargingJsonArray) {
        this.remoteSmartChargingJsonArray = remoteSmartChargingJsonArray;
    }
}
