        ...
        if (checkSum(readData,responseSize) && Objects.equals(readData[0], (byte)0x02) &&
            ...
            if (Objects.equals(readData[6],(byte)0xea)) {
                try {
                    ...
                    if (rfCardReaderListener != null) rfCardReaderListener.onRfCardDataReceive(ch, destData,true);
                } catch (Exception e) {
            ...
            if (rfCardReaderListener != null) {
                rfCardReaderListener.onRfCardDataReceive(ch, "0000000000000000", false);
            }
        }
    }
